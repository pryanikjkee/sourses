...
<div id="pull__quote__content" class="<?php print $myclass; ?> <?php print  $opacitypull; ?>" <?php if(isset($content['field_la_bg_color'])): ?> style="background: <?php print $content['field_la_bg_color']['#items'][0]['rgb']; ?>" <?php endif; ?>>>
